...
An interactive household electricity-planning sandbox for Peninsular Malaysia. Configure appliances and routines, simulate a billing month, and explore how usage changes the estimated bill.
