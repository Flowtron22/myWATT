...
const defaults = [
  ...
  { id: 'waterpurifier', name: 'Water purifier / dispenser', icon: '◈', watts: 500, hours: 24, qty: 1, duty: .18, on: true, awayOn: true, start: 0, room: 'Kitchen', variant: 'Hot + cold tank · Coway Neo Plus', variantLabel: 'Which kind do you own?', variants: [{ label:'Basic tap / under-sink filter', watts:0, duty:0 },{ label:'Room-temperature purifier', watts:10, duty:.5 },{ label:'Cold + room dispenser', watts:120, duty:.25 },{ label:'Hot + cold tank · Coway Neo Plus', watts:500, duty:.18 },{ label:'Hot + cold tank · Cuckoo King Top', watts:400, duty:.2 },{ label:'Instant hot + cold · Coway Kecil', watts:2600, duty:.025 },{ label:'Alkaline ionizer · Panasonic', watts:130, duty:.01 }], note: 'Coway Neo Plus = hot + cold tank. It keeps stored water hot and cold, so its heater and compressor switch on automatically throughout the day.' },
